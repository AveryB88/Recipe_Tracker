...
// create an empty initial state for the inputs to placed
// set formData to the initialFormState using a useState method.
// use the handleSubmit to create an event
